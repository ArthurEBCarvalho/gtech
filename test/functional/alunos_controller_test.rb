...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { endereco: @aluno.endereco, nascimento: @aluno.nascimento, nome: @aluno.nome }
    end
  ...
  test "should update aluno" do
    put :update, id: @aluno, aluno: { endereco: @aluno.endereco, nascimento: @aluno.nascimento, nome: @aluno.nome }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
