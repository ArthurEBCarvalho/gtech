...
class ProvasControllerTest < ActionController::TestCase
  ...
  test "should create prova" do
    assert_difference('Prova.count') do
      post :create, prova: { aluno_id: @prova.aluno_id, data: @prova.data, materia_id: @prova.materia_id, nota: @prova.nota }
    end
  ...
  test "should update prova" do
    put :update, id: @prova, prova: { aluno_id: @prova.aluno_id, data: @prova.data, materia_id: @prova.materia_id, nota: @prova.nota }
    assert_redirected_to prova_path(assigns(:prova))
  end
